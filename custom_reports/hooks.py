...
app_title = "Custom stock reports"
app_publisher = "Aits"
app_description = "Warehouse wise custom stock reports"
...
# Optional: Fixtures if you have custom fields/workspaces
fixtures = [
    {
        "doctype": "Workspace",
        "filters": [["module", "=", "Custom Stock Reports"]]
    }
]